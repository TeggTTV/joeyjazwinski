...
export default function JsonToSqlInsert() {
	...
	return (
		<>
			<NextSeo
				title="JSON/CSV to SQL Insert Script Generator - Joey Jazwinski"
				description="Quickly convert structured JSON objects or CSV datasets into raw SQL INSERT statements client-side."
			/>
