			...
			<main className="min-h-screen bg-background pt-32 pb-16 px-4 sm:px-6 lg:px-8 text-foreground">
				<div className="max-w-6xl mx-auto space-y-12">
					...
					<div className="bg-card/60 backdrop-blur-xl border border-border/80 rounded-2xl p-6 sm:p-8 space-y-4 shadow-xl">
						...
						<div className="w-full max-h-125 overflow-y-auto rounded-xl border border-border bg-background/40 font-mono text-sm shadow-inner overflow-x-auto">
							{diffResult.length > 0 ? (
								...
								<div className="p-8 text-center text-muted-foreground italic">
									No differences to display. Add text above to
									run comparison...
								</div>
							)}
						</div>
