...
export const getStaticProps: GetStaticProps = async ({ params }) => {
	...
	// 	try {
	// 		const response = await fetch(getFullUrl('/api/updateCourse'), {
	// 			method: 'POST',
	// 			credentials: 'include',
	// 			// body: JSON.stringify({
	// 			// 	slug: params?.slug,
	// 			// }),
	// 		});
	// 		// console.log('updateCourses response:', response);
	...
	const course = courses.find((c) => c.slug === slug) || courseData[slug];
