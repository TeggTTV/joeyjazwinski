		...
		>
			<div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-center items-center px-4 sm:px-6 md:px-8">
				...
				>
					...
					<div className="flex items-center justify-between px-5 py-3 rounded-t-[calc(1.5rem-0.25rem)] bg-zinc-100/90 dark:bg-zinc-950/90 border-b border-zinc-200 dark:border-white/5">
						<div className="flex items-center gap-3">
							...
							<span className="text-[11px] font-mono text-zinc-500 dark:text-zinc-400 border-l border-zinc-300 dark:border-white/10 pl-3">
								WORKBENCH.SYS // ACTIVE SLOT 0{activeToolIndex + 1}
							</span>
						</div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-12 gap-2 p-2 min-h-[380px] bg-zinc-50/50 dark:bg-black/40 rounded-b-[calc(1.5rem-0.25rem)]">
						...
						<div className="lg:col-span-8 rounded-2xl bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-white/10 p-6 relative flex flex-col justify-center overflow-hidden shadow-inner min-h-[340px]">
									...
									<div className="flex items-center justify-between border-b border-zinc-200 dark:border-white/10 pb-3 mb-4">
										<div className="flex items-center gap-2">
											...
											<span className="font-mono text-xs font-bold text-amber-500">
												REGEX SIMULATOR // AST TOKEN TREE
											</span>
										</div>
							...
							>
									...
									<div className="flex items-center justify-between border-b border-zinc-200 dark:border-white/10 pb-3 mb-4">
										<div className="flex items-center gap-2">
											...
											<span className="font-mono text-xs font-bold text-emerald-500">
												IMAGE QUANTIZATION // CANVAS PIPELINE
											</span>
										</div>
								...
								<div className="flex items-center justify-between pt-3 border-t border-zinc-200 dark:border-white/10 text-[11px] font-mono text-zinc-500">
									<span>Canvas context: 2D ImageBitmap</span>
							...
							>
									...
									<div className="flex items-center justify-between border-b border-zinc-200 dark:border-white/10 pb-3 mb-4">
										<div className="flex items-center gap-2">
											...
											<span className="font-mono text-xs font-bold text-rose-500">
												MYERS LCS DIFF // UNIFIED INSPECT
											</span>
										</div>
								...
								<div className="flex items-center justify-between pt-3 border-t border-zinc-200 dark:border-white/10 text-[11px] font-mono text-zinc-500">
									...
									<span className="text-emerald-500">Optimized branch</span>
								</div>
							</div>
							...
							>
								<div>
									<div className="flex items-center justify-between border-b border-zinc-200 dark:border-white/10 pb-3 mb-4">
										<div className="flex items-center gap-2">
											...
											<span className="font-mono text-xs font-bold text-purple-500">
												EPHEMERAL RUNTIME // IFRAME PREVIEW
											</span>
										</div>
									...
									<div className="rounded-xl border border-zinc-200 dark:border-white/10 overflow-hidden bg-zinc-100 dark:bg-zinc-900/60 p-4 flex flex-col items-center justify-center min-h-[140px]">
								...
								<div className="flex items-center justify-between pt-3 border-t border-zinc-200 dark:border-white/10 text-[11px] font-mono text-zinc-500">
									...
									<span className="text-purple-500">Sandbox isolated</span>
								</div>
							</div>
						</div>
					</div>
