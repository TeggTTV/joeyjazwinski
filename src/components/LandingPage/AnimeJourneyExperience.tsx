...
const stations: MilestoneStation[] = [
	{
		...
		story: 'In sixth grade, a friend opened the developer console and triggered an alert box. Seeing direct code execute on screen sparked an immediate, lifelong obsession with software creation.',
	...
	},
	{
		...
		story: 'Built my first raw HTML and CSS pages. My older brother Kevin and I spent weekends at the local library coding side-by-side, cementing my work ethic and developer curiosity.',
	...
	},
	{
		...
		story: 'Dove into Python automation scripts. Built an automated typing bot for school typing time-trials that reached 260+ WPM, realizing the power of scripting to solve immediate challenges.',
	...
	},
	{
		...
		story: 'Mastered modern JavaScript and asynchronous APIs. Deployed a full-stack web application hosted on Firebase with user authentication and real-time database synchronization.',
	...
	},
	{
		...
		story: 'Refocused deeply on software architecture, design patterns, clean code, and React component performance, solidifying professional-grade engineering habits.',
	...
	},
	{
		...
		story: 'Headed into senior year of high school with years of hands-on production code under my belt. Prepared for higher education with a clear ambition to leave an engineering mark on the world.',
	...
	},
	{
		...
		story: 'Began university studies in Computer Science at Adelphi University, taking full advantage of campus labs, collaborative research, and modern cloud engineering initiatives.',
			...
			>
				...
				<div className="text-left mb-8 max-w-xl mx-auto">
					...
					<p className="text-xs sm:text-sm text-muted-foreground">
						Milestones tracing the journey from middle school
						discovery to modern full-stack systems.
					</p>
				</div>
				...
				<div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-center items-center px-4 sm:px-6 md:px-8">
					...
					<div className="text-center max-w-2xl mx-auto mb-4 relative z-20">
						...
						<p className="text-xs sm:text-sm text-zinc-500 dark:text-muted-foreground mt-1">
							Scroll to traverse 8 milestone stations along the
							developer release train
						</p>
					</div>
					...
					>
						...
						<div className="flex items-center justify-between px-5 py-3 rounded-t-[calc(1.5rem-0.25rem)] bg-zinc-100/90 dark:bg-zinc-950/90 border-b border-zinc-200 dark:border-white/5 font-mono text-[11px]">
							<div className="flex items-center gap-3">
								...
								<span className="text-zinc-500 dark:text-zinc-400">
									TRANSIT://STATION-0{activeStationIndex + 1}{' '}
						...
						<div className="grid grid-cols-1 lg:grid-cols-12 gap-2 p-2 min-h-100 bg-zinc-50/50 dark:bg-black/40 rounded-b-[calc(1.5rem-0.25rem)]">
