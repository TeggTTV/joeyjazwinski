			...
			>
				...
				<div className="text-left mb-8 max-w-xl mx-auto">
					...
					<p className="text-xs sm:text-sm text-muted-foreground">
						Cryptographically validated certifications and
				...
				<div className="max-w-xl mx-auto space-y-4">
					...
					<div className="rounded-2xl border border-border/80 bg-card/90 backdrop-blur-md p-5 shadow-xs">
						...
						<p className="text-xs text-muted-foreground leading-relaxed mb-3">
							Generative AI, prompt crafting, and ethical
							implementation in modern developer workflows.
						</p>
					...
					<div className="rounded-2xl border border-border/80 bg-card/90 backdrop-blur-md p-5 shadow-xs">
						...
						<p className="text-xs text-muted-foreground leading-relaxed mb-3">
							Threat modeling, defensive architectures, packet
					...
					<div className="rounded-2xl border border-border/80 bg-card/90 backdrop-blur-md p-5 shadow-xs">
						...
						<p className="text-xs text-muted-foreground leading-relaxed mb-3">
							...
							heuristic evaluation, and research methodologies.
						</p>
						<div className="text-[10px] font-mono text-muted-foreground flex items-center justify-between pt-2 border-t border-border/50">
							<span>ISSUER: GOOGLE</span>
					...
					<div className="rounded-2xl border border-border/80 bg-card/90 backdrop-blur-md p-5 shadow-xs">
						...
						<p className="text-xs text-muted-foreground leading-relaxed mb-3">
							Component lifecycles, state composition, RESTful API
							consumption, and HTTP payload handling.
						</p>
						<div className="text-[10px] font-mono text-muted-foreground flex items-center justify-between pt-2 border-t border-border/50">
					...
					<div className="rounded-2xl border border-purple-500/30 bg-purple-500/5 backdrop-blur-md p-5 shadow-xs">
						...
						<p className="text-xs text-muted-foreground leading-relaxed mb-4">
							Advancing computer science education, cloud
							architectures, and academic research.
						</p>
						<Link
				...
				<div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-center items-center px-4 sm:px-6 md:px-8">
					...
					<div className="text-center max-w-2xl mx-auto mb-6 relative z-20">
						...
						<p className="text-xs sm:text-sm text-zinc-500 dark:text-muted-foreground mt-1">
							Vertical laser scanner authenticates cryptographic
							certifications
						</p>
					</div>
					...
					>
						...
						<div className="flex items-center justify-between px-4 py-2 mb-4 rounded-xl bg-zinc-100 dark:bg-zinc-950/80 border border-zinc-200 dark:border-white/5 font-mono text-[11px]">
							<div className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400">
								...
								<span>
									VAULT://JJ-DEV-PASS • SHA-256 VERIFIED
								</span>
							</div>
							<div className="flex items-center gap-2">
								...
								<span className="text-emerald-600 dark:text-emerald-400 font-bold">
									{activeLayer === 0 &&
										'LAYER 01: GOOGLE AI & SECURITY'}
									{activeLayer === 1 &&
										'LAYER 02: UX & WEB ARCHITECTURE'}
									{activeLayer === 2 &&
										'LAYER 03: ADELPHI UNIVERSITY'}
								</span>
							</div>
						</div>
						...
						<div
							ref={badgeCardRef}
							className="relative min-h-95 rounded-2xl bg-white dark:bg-zinc-950 border border-zinc-300 dark:border-white/15 p-6 sm:p-8 shadow-2xl overflow-hidden"
						>
							...
							>
								<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
									<div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/60 border border-zinc-200 dark:border-white/10">
										...
										<p className="text-xs text-zinc-500 dark:text-muted-foreground leading-relaxed">
											Generative AI, prompt crafting, and
											ethical implementation in modern
											developer workflows.
										</p>
									...
									<div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/60 border border-zinc-200 dark:border-white/10">
										...
										<p className="text-xs text-zinc-500 dark:text-muted-foreground leading-relaxed">
											Threat modeling, defensive
											architectures, packet inspection,
								...
								<div className="pt-4 border-t border-zinc-200 dark:border-white/10 flex items-center justify-between text-[11px] font-mono text-zinc-500">
									<span>
										Cryptographic hash validated by Google
										Coursera partner portal
									</span>
							...
							>
								<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
									...
									<div className="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/60 border border-zinc-200 dark:border-white/10">
										...
										<p className="text-xs text-zinc-500 dark:text-muted-foreground leading-relaxed">
											Component lifecycles, state
											composition, RESTful API
											consumption, and HTTP payload
											handling.
										</p>
										<div className="mt-3 flex items-center justify-between text-[10px] font-mono text-emerald-500">
											<span className="flex items-center gap-1">
							...
							>
								<div className="max-w-md my-auto">
									...
									<p className="text-xs text-zinc-500 dark:text-muted-foreground mt-1 mb-4 leading-relaxed">
										...
										cloud architectures, and academic
										research alongside industry certified
										skillsets.
									</p>
									<Link
										href="/about#certifications"
