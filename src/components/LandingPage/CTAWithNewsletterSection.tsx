        ...
        <section className="w-full py-16 px-6 md:px-20 bg-white">
            <div className="flex flex-col md:flex-row gap-10 items-start md:items-center justify-between">
                ...
                >
                    ...
                    <motion.div className='w-max' whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.95 }}>
                        <Link href="/signup" className="inline-block px-6 py-3 bg-white text-blue-600 font-semibold rounded-full shadow-md hover:bg-gray-100">
                            Get Started
                        </Link>
                    </motion.div>
                </motion.div>
                ...
                >
                    ...
                    <p className="text-lg text-gray-700 mb-6">Subscribe to our newsletter for the latest updates and tutorials.</p>
