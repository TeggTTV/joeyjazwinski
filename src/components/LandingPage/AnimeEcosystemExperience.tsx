				...
				<div className="max-w-xl mx-auto space-y-6">
					...
					<div className="rounded-2xl border border-border/80 bg-card p-5 sm:p-6 shadow-sm transition-all">
						...
						<p className="text-xs sm:text-sm text-muted-foreground mb-4 leading-relaxed">
							Explore production web applications, SaaS tools, and
							open-source packages crafted with modern stacks and
					...
					<div className="rounded-2xl border border-border/80 bg-card p-5 sm:p-6 shadow-sm transition-all">
						...
						<p className="text-xs sm:text-sm text-muted-foreground mb-4 leading-relaxed">
							Authored research articles covering Next.js deep
							dives, frontend performance metrics, state
							synchronization, and practical AI engineering.
						</p>
						...
						<div className="p-3 rounded-xl bg-muted/40 border border-border/60 font-mono text-[11px] mb-5 text-muted-foreground">
							...
							<span className="text-foreground font-sans text-xs font-medium line-clamp-2">
								Deconstructing React 19 Compiler, Turbopack
								Bundling, and Strict Type Systems
							</span>
						</div>
					...
					<div className="rounded-2xl border border-border/80 bg-card p-5 sm:p-6 shadow-sm transition-all">
						...
						<p className="text-xs sm:text-sm text-muted-foreground mb-4 leading-relaxed">
							In-browser developer tools: regular expression
							testers, media compressors, diff checkers, and
							sandboxes with zero server round-trips.
						</p>
			...
			{(!hasMounted || isDesktop) && (
				...
				>
					...
					>
						...
						<div className="absolute inset-0 pointer-events-none opacity-20 dark:opacity-25 bg-[linear-gradient(to_right,rgba(0,0,0,0.06)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,0,0,0.06)_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-size-[4rem_4rem] mask-[radial-gradient(ellipse_60%_50%_at_50%_50%,#000_70%,transparent_100%)]" />

						{/* Ambient glow orbs */}
						<div className="absolute top-1/3 left-1/4 w-120 h-120 rounded-full bg-blue-500/10 blur-[120px] pointer-events-none" />
						<div className="absolute bottom-1/4 right-1/4 w-120 h-120 rounded-full bg-purple-500/10 blur-[120px] pointer-events-none" />
						...
						>
							...
							<p className="text-base sm:text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">
								Dive into real-world codebases, technical
								research articles, and high-performance
								in-browser developer utilities.
							</p>
						</div>
						...
						>
								...
								<div className="space-y-4 font-mono">
									<div className="p-4 rounded-xl border border-border/60 bg-muted/40">
										...
										<p className="text-xs text-muted-foreground font-sans leading-relaxed">
											Full-stack architectures featuring
											Next.js 16, reactive state machines,
											and resilient API gateways.
										</p>
									</div>
							...
							<div className="w-full lg:w-1/2 text-left pointer-events-auto">
								...
								<p className="text-sm sm:text-base text-zinc-600 dark:text-muted-foreground leading-relaxed mb-6">
									Explore production web applications, SaaS
									tools, and open-source packages crafted with
									modern stacks and resilient architectural
									patterns.
								</p>
						...
						>
							...
							<div className="w-full lg:w-1/2 rounded-2xl border border-zinc-200 dark:border-white/15 bg-white/95 dark:bg-zinc-950/90 backdrop-blur-2xl p-6 shadow-xl dark:shadow-2xl overflow-hidden pointer-events-auto transition-colors">
								...
								<p className="text-xs text-zinc-600 dark:text-muted-foreground mb-4 leading-relaxed font-sans">
									Deep architectural dissections of React
									internals, TypeScript mechanics, and
								...
								<div className="rounded-xl border border-zinc-800 bg-zinc-950 p-4 font-mono text-xs text-zinc-300 space-y-1 overflow-x-auto">
									<p className="text-zinc-500">
										// Real-time architectural pattern
									</p>
									<p>
							...
							<div className="w-full lg:w-1/2 text-left pointer-events-auto">
								...
								<p className="text-sm sm:text-base text-zinc-600 dark:text-muted-foreground leading-relaxed mb-6">
									Authored research articles covering Next.js
									deep dives, frontend performance metrics,
									state synchronization, and practical AI
									engineering.
								</p>
								...
								<div className="space-y-2.5 mb-8 text-xs sm:text-sm text-zinc-800 dark:text-zinc-200 font-medium">
									<div className="flex items-center gap-2">
										...
										<span>
											React 19 & Next.js Core Architecture
										</span>
									</div>
									<div className="flex items-center gap-2">
										<CheckCircle2 className="w-4 h-4 text-purple-500" />
						...
						>
							...
							<div className="w-full lg:w-1/2 rounded-2xl border border-zinc-200 dark:border-white/15 bg-white/95 dark:bg-zinc-950/90 backdrop-blur-2xl p-6 shadow-xl dark:shadow-2xl overflow-hidden pointer-events-auto transition-colors">
								...
								<div className="space-y-3 font-mono text-xs">
									<div className="p-3 rounded-lg border border-border/70 bg-muted/40">
										<span className="text-muted-foreground block text-[10px] mb-1 font-semibold">
											REGEX ENGINE
										</span>
										...
										<span className="text-[10px] text-zinc-500 dark:text-muted-foreground mt-1 block">
											Match status: Validated in 0.04ms
											(Web Worker)
										</span>
									</div>
							...
							<div className="w-full lg:w-1/2 text-left pointer-events-auto">
								...
								<p className="text-sm sm:text-base text-zinc-600 dark:text-muted-foreground leading-relaxed mb-6">
									In-browser developer tools: regular
									expression testers, media compressors, diff
									checkers, and sandboxes with zero server
									round-trips.
								</p>
								...
								<div className="space-y-2.5 mb-8 text-xs sm:text-sm text-zinc-800 dark:text-zinc-200 font-medium">
									...
									<div className="flex items-center gap-2">
										<CheckCircle2 className="w-4 h-4 text-emerald-500" />
										<span>
											Zero Network Latency & Offline Ready
										</span>
									</div>
									<div className="flex items-center gap-2">
										<CheckCircle2 className="w-4 h-4 text-emerald-500" />
										<span>
											Engineered for Everyday Developer
											Productivity
										</span>
									</div>
								</div>
