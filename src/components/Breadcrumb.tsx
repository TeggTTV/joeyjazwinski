...
const Breadcrumb = () => {
	...
	return (
		<nav
			className="w-full max-w-6xl px-10 mb-5 mx-auto bg-white dark:bg-gray-800 py-3"
			...
			<ol className="flex items-center text-sm text-gray-600 dark:text-gray-300">
				...
				{breadcrumbs.map((crumb, i) => (
					<li key={crumb.href} className="flex items-center">
						...
						{i === breadcrumbs.length - 1 ? (
							...
							<Link
								href={crumb.href}
								className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-500 truncate max-w-[10ch] sm:max-w-none"
							>
								{crumb.label}
							</Link>
						)}
				...
				{extraCrumbs.map((crumb, i) => (
					...
					>
						...
						<Link
							href={crumb.href}
							className="text-green-600 dark:text-green-400 hover:text-green-800 dark:hover:text-green-500 font-medium truncate max-w-[10ch] sm:max-w-none"
						>
							{crumb.label}
						</Link>
					</li>
