	...
	return (
		...
		>
			<div className="max-w-7xl mx-auto">
				<div className="bg-linear-to-r from-primary to-primary/80 rounded-2xl p-8 md:p-12 text-white flex flex-col md:flex-row items-center justify-between gap-6">
					<div>
