/**
 * Curated list of distinct, memorable English words for Diceware passphrase generation.
 */
export const DICEWARE_WORDLIST: string[] = [
	'ability', 'absorb', 'abstract', 'academy', 'accent', 'acoustic', 'acquire', 'across', 'action', 'actor',
	'actress', 'actual', 'adapt', 'addition', 'address', 'adjust', 'admit', 'adult', 'advance', 'advice',
	'aerobic', 'affair', 'afford', 'afraid', 'agency', 'agenda', 'agent', 'agree', 'ahead', 'airline',
	'airport', 'alarm', 'album', 'alcohol', 'alert', 'alien', 'allied', 'almost', 'alpha', 'alpine',
	'already', 'alright', 'alter', 'always', 'amateur', 'amazing', 'amber', 'ambient', 'amount', 'amused',
	'anchor', 'ancient', 'android', 'angel', 'animal', 'animate', 'ankle', 'announce', 'annual', 'another',
	'answer', 'antenna', 'antique', 'anxiety', 'anybody', 'anyway', 'apart', 'apology', 'appeal', 'appear',
	'apple', 'approve', 'apron', 'arcade', 'arctic', 'arena', 'armor', 'arrow', 'artist', 'aspect',
	'assault', 'asset', 'assist', 'assume', 'athlete', 'atlas', 'atomic', 'attack', 'attend', 'attitude',
	'attract', 'auction', 'audit', 'august', 'author', 'auto', 'autumn', 'average', 'avocado', 'avoid',
	'awake', 'award', 'aware', 'awesome', 'axis', 'bacon', 'badge', 'balance', 'balcony', 'bamboo',
	'banana', 'banner', 'baron', 'barrier', 'basic', 'basket', 'battery', 'battle', 'beacon', 'beauty',
	'because', 'become', 'bedroom', 'before', 'begin', 'behave', 'behind', 'believe', 'benefit', 'between',
	'beyond', 'bicycle', 'binary', 'biology', 'biscuit', 'bitter', 'bizarre', 'black', 'blade', 'blanket',
	'blender', 'blessing', 'blizzard', 'block', 'blonde', 'bloom', 'blossom', 'blueberry', 'board', 'boil',
	'bold', 'bomb', 'bonus', 'boost', 'border', 'borrow', 'bounce', 'bracket', 'brain', 'branch',
	'brass', 'brave', 'bread', 'breeze', 'brick', 'bridge', 'brief', 'bright', 'bring', 'brisk',
	'broad', 'bronze', 'brother', 'bubble', 'budget', 'buffalo', 'bullet', 'bundle', 'bunker', 'burden',
	'burger', 'cactus', 'calendar', 'calm', 'camera', 'campfire', 'campus', 'canal', 'candle', 'candy',
	'canvas', 'canyon', 'capable', 'capital', 'captain', 'carbon', 'cardiac', 'careful', 'cargo', 'carpet',
	'carrot', 'castle', 'casual', 'catalog', 'catch', 'category', 'cattle', 'cause', 'caution', 'caviar',
	'celery', 'cement', 'census', 'century', 'cereal', 'certain', 'chair', 'chalk', 'champion', 'change',
	'chaos', 'chapter', 'charge', 'chase', 'cheese', 'cherry', 'chest', 'chicken', 'chief', 'chimney',
	'choice', 'chronic', 'circle', 'circuit', 'circus', 'citizen', 'citrus', 'classic', 'clean', 'clever',
	'client', 'cliff', 'climate', 'climb', 'clinic', 'clock', 'clone', 'cloth', 'cloud', 'clover',
	'cluster', 'clutch', 'coach', 'coast', 'coconut', 'coffee', 'coherent', 'collect', 'colony', 'column',
	'combine', 'comedy', 'comfort', 'comic', 'command', 'common', 'compact', 'company', 'compare', 'compass',
	'compile', 'complex', 'compose', 'concert', 'conduct', 'confirm', 'connect', 'conquer', 'consent', 'console',
	'contact', 'contain', 'content', 'contour', 'control', 'convert', 'cookie', 'copper', 'coral', 'corner',
	'correct', 'cosmos', 'cotton', 'courage', 'cousin', 'cover', 'cradle', 'craft', 'crane', 'crater',
	'crayon', 'crazy', 'cream', 'credit', 'creek', 'cricket', 'crime', 'crisis', 'crisp', 'critic',
	'cross', 'crouch', 'crowd', 'crucial', 'cruise', 'crunch', 'crystal', 'cube', 'culture', 'cupboard',
	'curator', 'curious', 'current', 'curtain', 'cushion', 'custom', 'cyber', 'cycle', 'cylinder', 'dagger',
	'damage', 'dancer', 'danger', 'daring', 'dash', 'database', 'dawn', 'daylight', 'dazzle', 'dealer',
	'decade', 'decide', 'decimal', 'declare', 'decor', 'decrease', 'defense', 'define', 'defy', 'degree',
	'delay', 'deliver', 'demand', 'demise', 'density', 'dentist', 'depart', 'depend', 'deposit', 'depth',
	'deputy', 'derive', 'describe', 'desert', 'design', 'desktop', 'despair', 'destroy', 'detail', 'detect',
	'develop', 'device', 'devote', 'diagram', 'dial', 'diamond', 'diary', 'diesel', 'diet', 'differ',
	'digital', 'dignity', 'dilemma', 'dinner', 'dinosaur', 'direct', 'disaster', 'discover', 'display', 'distance',
	'divert', 'divide', 'divorce', 'dizzy', 'doctor', 'document', 'dolphin', 'domain', 'donate', 'donkey',
	'double', 'dragon', 'drain', 'drama', 'drawer', 'dream', 'dress', 'drift', 'drill', 'driver',
	'drone', 'drop', 'druid', 'drum', 'dryer', 'duck', 'duet', 'dune', 'during', 'dynamic',
	'eager', 'eagle', 'early', 'earn', 'earth', 'easily', 'east', 'echo', 'eclipse', 'ecology',
	'economy', 'edge', 'edition', 'educate', 'effort', 'eight', 'either', 'elbow', 'elder', 'electric',
	'elegant', 'element', 'elephant', 'elevator', 'elite', 'embark', 'embody', 'embrace', 'emerald', 'emerge',
	'emission', 'emotion', 'employ', 'empower', 'empty', 'enable', 'enact', 'endless', 'endorse', 'enemy',
	...
	'fade', 'faint', 'faith', 'falcon', 'false', 'fame', 'family', 'famous', 'fantasy', 'farmer',
	'fashion', 'fatigue', 'fault', 'favorite', 'feature', 'february', 'federal', 'feedback', 'feeling', 'fellow',
	'female', 'fence', 'festival', 'fetch', 'fever', 'fiber', 'fiction', 'field', 'figure', 'filter',
	'final', 'finder', 'finger', 'finish', 'fire', 'firm', 'first', 'fiscal', 'fitness', 'flavor',
	'flicker', 'flight', 'flip', 'float', 'flock', 'floor', 'flower', 'fluid', 'flush', 'flyer',
	'focus', 'fog', 'foil', 'fold', 'follow', 'food', 'foot', 'force', 'forest', 'forget',
	'fork', 'fortune', 'forum', 'forward', 'fossil', 'foster', 'founder', 'fraction', 'fragment', 'frame',
	'freedom', 'freeze', 'frequent', 'fresh', 'friction', 'friend', 'fridge', 'frog', 'front', 'frost',
	'fruit', 'fuel', 'fun', 'funny', 'furnace', 'future', 'gadget', 'galaxy', 'gallery', 'game',
	...
	'golden', 'golf', 'gorgeous', 'gospel', 'gossip', 'govern', 'gown', 'grab', 'grace', 'grain',
	'grand', 'grant', 'grape', 'graph', 'gravity', 'gray', 'great', 'green', 'grid', 'grief',
	'grill', 'grip', 'grit', 'grocery', 'group', 'grow', 'grunt', 'guard', 'guess', 'guide',
	'guilt', 'guitar', 'gun', 'gym', 'habit', 'hair', 'half', 'hammer', 'hand', 'handle',
	'harbor', 'hard', 'harvest', 'hat', 'hazard', 'head', 'health', 'heart', 'heavy', 'hedgehog',
	...
	'inside', 'inspire', 'install', 'intact', 'integer', 'intellect', 'intend', 'intense', 'intent', 'interact',
	'interest', 'interior', 'internal', 'invest', 'invite', 'iron', 'island', 'isolate', 'issue', 'item',
	...
	'kinetic', 'kingdom', 'kiss', 'kit', 'kitchen', 'kite', 'kitten', 'kiwi', 'knee', 'knife',
	'knock', 'know', 'lab', 'label', 'labor', 'ladder', 'lady', 'lake', 'lamp', 'language',
	'laptop', 'large', 'laser', 'late', 'latin', 'laugh', 'laundry', 'lava', 'law', 'lawn',
	...
	'minute', 'miracle', 'mirror', 'misery', 'miss', 'mistake', 'mix', 'mixture', 'mobile', 'model',
	'modify', 'module', 'moist', 'moment', 'monitor', 'monkey', 'monster', 'month', 'moon', 'moral',
	...
	'obtain', 'obvious', 'ocean', 'october', 'odor', 'off', 'offer', 'office', 'often', 'oil',
	...
	'police', 'policy', 'pollen', 'pond', 'pony', 'pool', 'popular', 'portion', 'position', 'positive',
	...
	'proof', 'property', 'prosper', 'protect', 'proud', 'provide', 'public', 'pudding', 'pull', 'pulse',
	...
	'scene', 'scheme', 'school', 'science', 'scissors', 'scooter', 'scope', 'score', 'scout', 'scrap',
	...
	'spread', 'spring', 'spy', 'squad', 'square', 'stable', 'stadium', 'staff', 'stage', 'stair',
