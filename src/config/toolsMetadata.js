module.exports = {
	...
	'cron-visualizer': {
		...
		description:
			'Easily parse, validate, and visualize standard 5-part cron syntax expressions with calculated upcoming execution timelines and schedules.',
		category: 'DeveloperApplication',
	},
	'csv-to-markdown': {
	...
	'encoder-decoder': {
		...
		description:
			'Quickly encode and decode URL strings, Base64 data, and HTML entities client-side with one click and immediate clipboard copying.',
		category: 'DeveloperApplication',
	},
	'gif-generator': {
		...
		description:
			'Convert short video clips into high-quality animated GIFs directly in your browser with frame rate, width, and quality configuration.',
	...
	'json-to-sql-insert': {
		...
		description:
			'Convert arrays of JSON objects or CSV rows into clean SQL INSERT INTO statements for PostgreSQL, MySQL, and SQLite databases.',
		category: 'DeveloperApplication',
	},
	'json-to-zod-ts': {
	...
	'qrcode-generator': {
		...
		description:
			'Generate custom high-resolution QR codes for URLs, Wi-Fi passwords, contact cards, and text with custom color palettes and instant PNG downloads.',
		category: 'DesignApplication',
	},
	'redirect-rules': {
	...
	'word-counter': {
		...
		description:
			'Free real-time word counter, character counter, reading time estimator, and readability index calculator. Analyze documents client-side with zero latency.',
